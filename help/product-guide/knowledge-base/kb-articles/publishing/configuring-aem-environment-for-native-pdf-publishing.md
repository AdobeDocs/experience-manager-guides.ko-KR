---
title: 기본 AEM 게시를 위한 PDF 환경 구성
description: 기본 AEM 게시를 위한 PDF 환경 구성
...
기본 PDF 게시 엔진은 AEM crx-quickstart 폴더에서 노드 모듈을 생성하려면 Oracle JDK가 필요합니다. 기본적으로 다음 운영 체제를 지원합니다.
...
12. 이제 AEM 서버를 시작합니다.
13. 웹 편집기의 사전 설정에서 네이티브 PDF을 생성합니다.
...
5. Guides 버전 4.2 이상을 사용하는 경우 AEM 서버를 다시 시작하고 12단계로 이동합니다.
6. 이 문서 하단에 첨부된 &quot;_node_ modules.zip_&quot;을(를) crx-quickstart/profiles/nodejs—b1aad0a7-9079-e56c-1ed8-6fcabe8166/ 디렉터리에 복사합니다.
...
12. 웹 편집기의 사전 설정에서 네이티브 PDF을 생성합니다.
...
8. 아래 명령을 사용하여 Java가 설치되었는지 확인합니다
   ...
   i) /crx-quickstart/profiles/nodejs—b1aad0a7-9079-e56c-1ed8-6fcabe8166 폴더에서 **./node-darwin/bin/node** 명령을 실행합니다
...
10. 웹 편집기의 사전 설정에서 네이티브 PDF을 생성합니다.
