...
1. **템플릿** 창에서 **템플릿** 옆의 **+** 아이콘을 선택하고 **PDF 템플릿**&#x200B;을(를) 선택합니다.
...
1. 복제할 템플릿 위로 마우스를 가져간 후 **..** *옵션* 아이콘을 선택하고 컨텍스트 메뉴에서 **복제**&#x200B;를 선택합니다.
   ...
   **PDF 템플릿 복제** 대화 상자가 열립니다.
   ...
   <img src="assets/duplicate-template.png" alt="PDF 템플릿 복제" width="350">
...
<img src="assets/PDF-template-options.png" alt="PDF 템플릿 복제" width="350">
...
전역 및 폴더 수준 프로필 설정에 대한 자세한 내용은 Cloud Services의 설치 및 구성 안내서에서 [템플릿 구성](../cs-install-guide/conf-folder-level.md#id1889D0IL0Y4) 섹션을 참조하십시오.
...
1. 템플릿의 구성 요소를 보려면 다음 중 하나를 수행하십시오.
   ...
   * 페이지 레이아웃: 일반적인 PDF에는 전면 표지나 제목 페이지, TOC, 챕터, 색인, 인용 등 다양한 페이지가 포함되어 있습니다. 페이지 레이아웃 섹션을 통해 PDF을 구성하는 다양한 페이지의 디자인을 디자인할 수 있습니다. 자세한 내용은 [페이지 레이아웃](../native-pdf/components-pdf-template.md#page-layouts)을 참조하세요.
