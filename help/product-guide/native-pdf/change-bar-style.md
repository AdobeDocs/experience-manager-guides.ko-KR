...
변경 막대 표시에 대한 자세한 내용은 [PDF 출력 게시](../web-editor/native-pdf-web-editor.md)에서 *게시된 버전 사이에 변경 막대를 사용하여 PDF 만들기* 설정을 참조하십시오.
...
PDF 출력의 TOC에서 변경된 주제 왼쪽에 변경 막대를 추가할 수도 있습니다. `.changed-topic` 스타일에서 `-ro-change-bar-color` 특성을 사용하여 목차 목록의 업데이트된 주제에 대해 선택한 색상의 변경 막대를 추가할 수 있습니다.
