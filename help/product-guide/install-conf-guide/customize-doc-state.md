...
1. **프로필 만들기**&#x200B;를 클릭하고 다음 세부 정보를 입력하십시오.
   ...
   - **상태**&#x200B;에서 **허용된 상태**&#x200B;로 문서의 상태를 지정하십시오.

     기본 문서 상태는 초안, 편집, 검토 중, 승인됨 및 완료입니다.-
...
Experience Manager Guides 설정을 기반으로 문서 상태 변경을 자동화하는 지침을 제공하는 탭은 Cloud Service 또는 온프레미스입니다.
...
AEM Guides은 문서 개발 프로세스의 라이프사이클을 제어하는 데 도움이 되는 문서 승인 워크플로를 제공합니다.

Experience Manager Guides 설정을 기반으로 승인 워크플로를 활성화하는 지침은 Cloud Service 또는 온프레미스에서 확인할 수 있습니다.
