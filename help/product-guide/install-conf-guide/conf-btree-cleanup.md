---
title: 참조 저장소 정리 작업 구성
description: 참조 저장소 정리 작업 구성
...
참조 저장소 정리 작업을 설정하고 `Guides BTree deletion` 설정을 관리하여 시스템을 최적화하고 저장소를 정리합니다.

## 참조 저장소 정리 작업 구성

Experience Manager Guides 설정을 기반으로 참조 저장소 정리 작업을 구성하는 지침은 Cloud Service 또는 온프레미스입니다.
...
1. cron 표현식을 업데이트하여 참조 저장소 정리 스케줄러 작업 실행 빈도를 설정합니다.

1. 아래 표시된 대로 참조 저장소 정리 스케줄러를 구성합니다.
...
1. **Guides btree 삭제 사용** 설정(btree.deletion.enabled)을 사용하도록 설정합니다.
