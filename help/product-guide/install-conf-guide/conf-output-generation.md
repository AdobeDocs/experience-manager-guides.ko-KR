...
기본적으로 마지막으로 생성된 25개의 출력 목록이 표시됩니다. 목록에 표시할 출력 수를 변경하려면 `com.adobe.fmdita.config.ConfigManager` 번들의 **출력 목록 제한** 설정을 업데이트하십시오.

>[!ENDTABS]

>[!TIP]
>
> 출력 기록 작업에 대한 모범 사례는 [모범 사례 안내서](https://helpx.adobe.com/content/dam/help/en/xml-documentation-solution/cs-mar-22/Adobe-Experience-Manager-Guides_Best-Practices_EN.pdf)의 *출력 기록* 섹션을 참조하십시오.
