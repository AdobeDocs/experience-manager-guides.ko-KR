...
Cloud Service 또는 온프레미스 탭은 Experience Manager Guides 설정에 따라 필요한 전제 조건을 제공합니다.
...
Experience Manager Guides 설정에 따른 패키지 설치 지침은 Cloud Service 또는 온프레미스라는 탭에 제공됩니다.
...
## 설치된 템플릿을 사용하여 사이트 생성(Cloud Service의 경우)
...
1. **새 사전 설정 만들기:**
   ...
   6. **추가**&#x200B;를 선택하여 사전 설정을 만드십시오.
      ...
      ![새 AEM 사이트 사전 설정 만들기](/help/product-guide/knowledge-base/kb-articles/assets/publishing/new-output-preset.png){width="350" align="left"}
...
2. **AEM 사이트 사전 설정 구성:** 기본 제공(OOTB) 사이트를 구성하는 두 가지 옵션이 있습니다.
   ...
   **옵션 1: 사이트 드롭다운 사용**
   ...
   2. **게시 경로** 및 **주제 페이지** 템플릿이 자동으로 다음으로 설정되어 있는지 확인하십시오.
      - 게시 경로: Cloud Service: `/content/AEMG-Docs-Site/en/docs/product` 및 온-프레미스: `aemg-docs/en/docs/product1`
      - 주제 페이지 템플릿: 주제 페이지
   ...
   **옵션 2: 사이트 경로 사용**
   ...
   1. **사이트 경로**&#x200B;을(를) Cloud Service의 경우 `/content/AEMG-Docs-Site/en/docs/product`, 온-프레미스의 경우 `/content/aemg-docs/en/docs/product1`(으)로 수동으로 설정합니다.
...
1. **사이트 생성:**
   ...
   2. 생성된 사이트는 Cloud Service의 경우 `/content/AEMG-Docs-Site/en/docs/product`, 온-프레미스의 경우 `/content/aemg-docs/en/docs/product1` 경로에서 사용할 수 있습니다.
...
>[!NOTE]
>
> Cloud Service 설정의 경우 프로덕션에 배포하기 전에 모든 구성을 비프로덕션 환경에서 테스트하십시오. <br><br> 자세한 내용은 공식 [AEM as a Cloud Service에 배포](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/deploying/overview)를 참조하십시오.
