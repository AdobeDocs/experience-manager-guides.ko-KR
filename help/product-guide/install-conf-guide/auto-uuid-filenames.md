...
Experience Manager Guides 설정을 기반으로 UUID를 기반으로 자동 파일 이름을 구성하는 지침은 Cloud Service 또는 온프레미스입니다.
...
구성 파일을 만들려면 [구성 재정의](download-install-config-override.md#)의 지침을 사용하십시오. 구성 파일에서 다음 \(property\) 세부 정보를 제공하여 UUID를 기반으로 자동 파일 이름을 구성하십시오.
...
>[!NOTE]
>
> 이 옵션을 켜면 작성자가 새 주제 또는 맵 파일을 만드는 동안 파일 이름을 지정하는 옵션이 표시되지 않습니다. Assets UI 및 편집기에서 새 주제 또는 맵 파일을 만들 수 있습니다.
...
>[!NOTE]
>
> 기본적으로 이 옵션은 꺼져 있습니다. 이 옵션을 켜면 작성자가 새 주제 또는 맵 파일을 만드는 동안 파일 이름을 지정하는 옵션이 표시되지 않습니다. Assets UI 및 편집기에서 새 주제 또는 맵 파일을 만들 수 있습니다.
