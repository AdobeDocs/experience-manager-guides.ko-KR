...
> * 4.6.0 서비스 팩 4 이전에 릴리스된 버전을 사용하는 경우 먼저 버전 4.6.0 서비스 팩 4로 업그레이드해야 합니다. 사용 허가된 버전의 제품에 해당하는 [업그레이드 지침](./upgrade-aemg-latest-version.md)을(를) 따르십시오.
...
자세한 내용은 [이전 버전 제거](../install-conf-guide/version-management.md#purge-older-versions-of-dita-files)를 참조하십시오.
