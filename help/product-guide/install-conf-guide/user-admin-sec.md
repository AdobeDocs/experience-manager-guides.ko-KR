...
Adobe Experience Manager 설명서의 다음 항목은 사용자 관리 및 보안 관련 개념과 기능을 이해하는 데 도움이 됩니다.
...
- 기본적으로 *게시자*&#x200B;에게는 DAM의 다음 폴더에 대한 액세스 및 권한이 부여됩니다.
   ...
   - `/content/fmdita` -\> 읽기 및 쓰기(적용 대상: ![](./assets/Smock_Cloud_18_N.svg))<br>``/var/dxml``-\> 읽기 및 쓰기(적용 대상: ![](./assets/Smock_Building_18_N.svg))
