...
# On-Premise용 AEM Guides 제거{#id21BHG0C0SXA}

CRX 패키지 관리자를 사용하여 AEM Guides for On-Premise를 제거할 수 있습니다. 제거하는 동안 저장소의 내용은 패키지를 설치하기 직전에 만든 스냅샷으로 되돌아갑니다.

AEM Guides for On-Premise를 제거하려면 다음 단계를 수행하십시오.
