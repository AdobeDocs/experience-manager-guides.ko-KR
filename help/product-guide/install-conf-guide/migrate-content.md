...
>[!TIP]
>
> 기존 콘텐츠 마이그레이션 및 업로드에 대한 모범 사례는 모범 사례 안내서의 *콘텐츠 마이그레이션 및 업로드* 섹션을 참조하십시오.

다음 표에서는 DITA 콘텐츠를 Experience Manager Guides에 업로드하는 데 사용할 수 있는 다양한 마이그레이션 방법을 간략하게 설명합니다. 또한 비 DITA 콘텐츠를 마이그레이션하고 UUID 파일 패턴을 구성하는 지침을 제공합니다.
