...
7. [폴더 프로필에서 스마트 제안 구성](./conf-profiles.md#configure-ai-assistant-for-smart-help-and-authoring)
...
1. **구성** 탭으로 전환합니다.
1. 이전 섹션에서 다운로드한 JSON 서비스 세부 정보를 `SERVICE_ACCOUNT_DETAILS`에 해당하는 **값** 필드에 붙여 넣습니다. 다음 스크린샷과 동일한 이름과 구성을 사용해야 합니다.
...
자세한 내용은 [폴더 프로필에서 스마트 제안 구성](./conf-profiles.md#configure-ai-assistant-for-smart-help-and-authoring)을 참조하세요.
