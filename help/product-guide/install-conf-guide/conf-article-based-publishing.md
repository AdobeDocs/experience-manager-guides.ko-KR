...
1. **XML Documentation 소프트웨어 배포 포털**&#x200B;에서 [Cloud Service용 Adobe 구성 요소 콘텐츠 패키지](https://experience.adobe.com/#/downloads/content/software-distribution/en/general.html)를 다운로드하십시오.
...
1. `Knowledge-base-template-for-article-based-publishing-for-cloud-service.zip`Adobe 소프트웨어 배포 포털[에서 &#x200B;](https://experience.adobe.com/#/downloads/content/software-distribution/en/general.html) 파일을 다운로드합니다.
