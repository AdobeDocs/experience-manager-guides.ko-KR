...
# Cloud Service에 대한 콘텐츠를 검색하도록 AI 기반 스마트 도움말을 구성합니다

관리자는 작성자에 대한 스마트 도움말 기능을 구성할 수 있습니다. 스마트 도움말 서비스는 Adobe IMS 인증 기반 인증을 통해 보호됩니다. Adobe의 보안 토큰 기반 인증 워크플로우와 환경을 통합하고 새로운 스마트 도움말 기능을 사용하십시오. 다음 구성은 폴더 프로필에 **AI 구성** 탭을 추가하는 데 도움이 됩니다. 추가되면 편집기에서 스마트 도움말 기능을 사용할 수 있습니다.
...
1. 프로젝트의 자격 증명 세부 정보를 보려면 **OAuth 서버 간** 링크를 선택하십시오.
   ...
   ![연결된 자격 증명](assets/conf-ss-connected-credentials.png) {width="800"}
...
구성하고 나면 편집기의 오른쪽 패널에 **스마트 도움말** ![스마트 도움말](assets/smart-help-icon.svg) 아이콘이 표시됩니다. 아이콘을 선택하여 **스마트 도움말** 패널을 보십시오.
