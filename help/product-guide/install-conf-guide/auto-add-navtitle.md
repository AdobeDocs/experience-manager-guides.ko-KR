...
Experience Manager Guides 설정을 기반으로 참조 파일의 속성에 기본적으로 `@navtitle` 특성을 포함하기 위한 지침을 제공하는 탭은 Cloud Service 또는 온프레미스입니다.
...
1. 글로벌 수준 또는 폴더 수준 프로필에서 이 변경 작업을 수행할 수 있습니다. 이를 변경할 위치에 따라 해당 ui\_config.json 파일을 다운로드해야 합니다. ui\_config.json 파일 다운로드에 대한 자세한 내용은 [XML Web Editor 구성 및 사용자 지정](conf-profiles.md#id2065G300O5Z)을 참조하십시오.
...
1. ui\_config.json 파일을 다운로드합니다.
   ...
   글로벌 수준 또는 폴더 수준 프로필에서 이 변경 작업을 수행할 수 있습니다. 이를 변경할 위치에 따라 해당 ui\_config.json 파일을 다운로드해야 합니다. ui\_config.json 파일 다운로드에 대한 자세한 내용은 [XML Web Editor 구성 및 사용자 지정](conf-profiles.md#id2065G300O5Z)을 참조하십시오.
