...
1. 다음 필터를 적용하여 로그 파일의 텍스트를 강조 표시합니다.
   ...
   - **경고**: 로그 파일의 경고를 주황색으로 강조 표시합니다.
   - **정보**: 로그 파일의 정보 메시지를 녹색으로 강조 표시합니다.

1. 위쪽 및 아래쪽 탐색 단추를 사용하여 로그 파일에서 강조 표시된 텍스트로 이동합니다. 또는 로그 파일을 스크롤하여 메시지를 확인합니다.

1. 로그 파일에서 다음 작업을 수행할 수 있습니다.

   - **로그 다운로드**: 로그 목록이 광범위하면 보다 쉽게 액세스하고 검토할 수 있도록 **로그 다운로드**&#x200B;를 선택하여 장치에 로그 파일을 다운로드합니다.
   - **로그 복사**: 로그 목록을 클립보드에 복사하여 일부 텍스트 편집기에 빠르게 붙여넣을 수 있습니다.
