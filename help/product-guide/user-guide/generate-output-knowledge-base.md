...
| Salesforce 옵션 | 설명 |
| --- | --- |
| 프로필 게시 | 드롭다운을 사용하여 관리자가 구성하는 Salesforce 연결 프로필에서 선택합니다. 관리자가 게시 프로필을 만드는 방법에 대해 자세히 알아보려면 **탭 모음** 섹션에서 **Workspace 설정**(**On-Prem**&#x200B;에 대해 [설정](./web-editor-features.md#tab-bar)(으)로 표시) 기능 설명을 확인하십시오. |
