...
1. 탐색기 패널에서 **새 파일** 아이콘을 선택한 다음 드롭다운 메뉴에서 **DITA 맵**&#x200B;을(를) 선택합니다.

   ![](images/create-map-options.png)

   [Experience Manager Guides 홈 페이지](./intro-home-page.md)와 탐색기 보기에서 폴더의 옵션 메뉴에서도 이 옵션에 액세스할 수 있습니다.
...
3. **새 맵** 대화 상자에서 다음 세부 정보를 제공합니다.
   ...
   - 맵 파일을 저장할 경로입니다. 기본적으로 탐색기에서 현재 선택한 폴더의 경로가 경로 필드에 표시됩니다.
...
1. 맵 파일이 맵 편집기에서 열립니다. 새 맵 파일을 연 경우 편집기에 맵의 제목만 표시됩니다.
   ...
   - **B** - \(*도구 모음*\) 맵 파일로 작업할 수 있는 도구 모음입니다. 도구 모음을 통해 사용할 수 있는 기능에 대한 자세한 내용은 맵 편집기의 도구 모음에서 사용할 수 있는 [기능](./map-editor-advanced-map-editor.md)을 참조하세요.
   ...
   - **D** - \(*왼쪽 패널*\): 컬렉션, 탐색기, 맵, 윤곽선 및 기타 기능에 액세스할 수 있는 왼쪽 패널에 액세스할 수 있습니다. 확장/축소 아이콘을 선택하여 확장 또는 축소할 수 있습니다. 왼쪽 패널에서 사용할 수 있는 기능에 대한 자세한 내용은 편집기에서 [왼쪽 패널](./web-editor-left-panel.md)을 확인하세요.
...
1. 왼쪽 패널에서 **탐색기** 보기로 전환합니다.

1. Adobe Experience Manager 탐색기에서 추가할 주제 또는 하위 맵이 포함된 폴더로 이동합니다.

1. **탐색기** 보기에서 주제 또는 맵 파일을 선택하고 \(가운데\) 맵 콘텐츠 편집 영역으로 드래그 앤 드롭합니다.

   항목이 맵에 추가됩니다.

   ![맵 편집기 항목 추가](images/map-editor-add-topic.png)
...
1. **만들기**&#x200B;를 선택합니다.
   ...
   구성된 맵 편집기에서 편집할 맵을 열거나 탐색기에서 맵 파일을 저장하도록 선택할 수 있습니다.
