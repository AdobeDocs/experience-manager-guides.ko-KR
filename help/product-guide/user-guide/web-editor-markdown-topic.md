...
| 기능 | 설명 |
|----------------|----------------|
| 작업 편집 | **잘라내기** ![](images/S_Cut_18_N.svg), **실행 취소** ![](images/S_Undo_18_N.svg), **다시 실행** ![](images/S_Redo_18_N.svg), **복사** ![](images/S_Copy_18_N.svg), **삭제** ![](images/S_Delete_18_N.svg) 및 **찾기 및 바꾸기** ![](images/S_FindAndReplace_18_N.svg)를 포함한 다양한 문서 편집 기능에 대한 액세스를 제공합니다. **메뉴** 드롭다운에서 사용 가능한 옵션에 액세스할 수 있습니다. |
| 텍스트 서식 옵션 | **제목** ![](images/S_DisplayHeading_18_N.svg), **굵게** ![](images/S_TextBold_18_N.svg), **기울임꼴** ![](images/S_TextItalic_18_N.svg), **취소선** ![](images/S_TextStrikethrough_18_N.svg), **코드** ![](images/S_Code_18_N.svg) 및 **견적 차단** ![](images/S_BlockQuoteMultipleLines_18_N.svg)을 비롯한 다양한 텍스트 서식 옵션에 대한 액세스를 제공합니다. |
| 콘텐츠 삽입 옵션 | **번호 매기기 목록** ![](images/S_TextNumbered_18_N.svg), **순서가 지정된 목록** ![](images/S_TextBulleted_18_N.svg), **테이블** ![](images/tableAdd.svg), **이미지** ![](images/S_ImageAdd_18_N.svg), **상호 참조** ![](images/S_LinkGlobe_18_N.svg) 및 **기호** ![](images/S_SpecialCharacter_18_N.svg)을 문서에 삽입하는 옵션을 제공합니다.<br><br> **참고**: 이미지 및 기타 파일을 Markdown 편집기로 끌어서 놓을 수도 있습니다. 파일은 상호 참조 링크로 추가되지만 이미지는 표준 이미지 요소로 표시됩니다. |
