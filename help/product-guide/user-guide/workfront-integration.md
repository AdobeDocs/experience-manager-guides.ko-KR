...
3. **Assets** 탭에서 **추가**&#x200B;를 선택하여 이 작업에 에셋을 추가합니다.
   ...
   * 검토 작업의 경우 먼저 에셋 유형(맵 또는 주제)을 선택하라는 메시지가 표시된 후 선택한 파일이 다음과 같이 표시됩니다.
     ...
     ![리뷰 작업에 맵 추가](./images/attach-asset-topics.png)

     *검토 작업에 항목 추가*

     ![리뷰 작업에 맵 추가](./images/attach-asset-maps.png)
...
1. [개요](#accessing-assigned-tasks-from-overview-section) 섹션 또는 [사용자에게 할당](#managing-tasks-assigned-to-you) 탭에서 작업에 액세스합니다.
   ...
   ![사용자에게 할당된 탭에서 작업 작성](./images/authoring-task-access.png)

   *사용자에게 할당된 탭에서 작업 작성*

   ![작업 위젯에서 작업 작성](./images/authoring-task-access-your-tasks.png)

   *작업 위젯에서 작업 작성*
2. 작업할 작업에 마우스를 가져다 대고 ![](images/Smock_OpenIn_18_N.svg)을(를) 선택하여 엽니다. 작업을 선택하여 해당 작업을 열 수도 있습니다.
...
1. [개요](#accessing-assigned-tasks-from-overview-section) 섹션 또는 [사용자에게 할당](#managing-tasks-assigned-to-you) 탭에서 작업에 액세스합니다.
   ...
   ![사용자에게 할당된 탭에서 작업 검토](./images/review-task-access.png)

   *사용자에게 할당된 탭에서 작업 검토*

   ![작업 위젯에서 작업 검토](./images/review-task-access-your-tasks.png)
...
![작성자 모드에서 작업 검토](./images/review-task-author-mode.png)
...
1. [개요](#accessing-assigned-tasks-from-overview-section) 섹션 또는 [사용자에게 할당](#managing-tasks-assigned-to-you) 탭에서 작업에 액세스합니다.
   ...
   ![사용자에게 할당 탭의 번역 작업](./images/translation-tasks-access.png)

   *사용자에게 할당 탭의 번역 작업*

   ![작업 위젯의 번역 작업](./images/translation-tasks-access-your-tasks.png)

   *작업 위젯의 번역 작업*

2. 작업할 작업에 마우스를 가져다 대고 ![](images/Smock_OpenIn_18_N.svg)을(를) 선택하여 **맵 콘솔**&#x200B;에서 엽니다. 작업을 선택하여 해당 작업을 열 수도 있습니다.
...
1. [개요](#accessing-assigned-tasks-from-overview-section) 섹션 또는 [사용자에게 할당](#managing-tasks-assigned-to-you) 탭에서 작업에 액세스합니다.
   ...
   ![사용자에게 할당된 탭에서 작업 게시](./images/publishing-tasks-access.png)

   *사용자에게 할당된 탭에서 작업을 게시하는 중*

   ![작업 위젯에서 작업 게시](./images/publishing-tasks-access-your-tasks.png)
