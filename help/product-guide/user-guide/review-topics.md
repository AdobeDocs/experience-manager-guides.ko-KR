...
사용자에 태그를 지정하려면 댓글이나 회신에 `@`을(를) 입력하고 검토자 목록에서 사용자를 선택하십시오. 보다 쉽게 식별할 수 있도록 사용자의 이메일 주소와 함께 표시 이름이 표시됩니다. 이메일 주소를 사용할 수 없는 경우 대신 사용자 ID가 표시됩니다.
...
>[!TAB 조건 패널(DITAVAL 기반 조건 제외)]

![](./images/review-conditions-panel.png){width="350"}

>[!TAB 조건 패널(DITAVAL 기반 조건 사용)]
