...
조직 설정에서 기술 문서 작업을 시작하거나 문서를 라이브로 푸시하기 전에 기술 문서의 전체 완성도를 확인하려고 합니다. 이러한 요구는 다중 사용자 및 대규모 환경에서 더욱 필수적이 된다. Adobe Experience Manager Guides은 저장소에 있는 컨텐츠의 전반적인 상태와 설명서 프로세스에서 컨텐츠가 사용되는 방식에 대해 유용한 insight을 제공하는 몇 가지 보고서를 제공합니다.
