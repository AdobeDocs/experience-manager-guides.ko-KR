...
>[!IMPORTANT]
>
> 새로운 맵 컬렉션은 2026.08.0 릴리스부터 Experience Manager Guides as a Cloud Service에서 사용할 수 있습니다. 이 기능을 활성화하려면 고객 지원 팀에 문의하십시오.
...
새로운 맵 컬렉션은 이전의 맵 컬렉션 기능과 일괄 게시 기능을 하나의 통합 인터페이스로 통합합니다. 활성화되면 한 위치에서 맵, 사전 설정, 생성 내역, 게시 내역, 메타데이터 및 컬렉션 멤버십을 관리할 수 있습니다.

## 맵 컬렉션 만들기 및 DITA 맵 추가

맵 컬렉션을 만들고 맵을 추가하려면 다음 단계를 수행하십시오.

1. Experience Manager Guides 홈 페이지를 열고 **컬렉션 매핑**&#x200B;을 선택합니다.
...
1. **맵 컬렉션** 페이지에서 오른쪽 상단의 **만들기**&#x200B;를 선택하고 맵 컬렉션에 대한 **이름**&#x200B;을 제공합니다.
...
>[!NOTE]
>
> 맵 컬렉션에 맵이 대량으로 추가되면 맵 및 사전 설정 탭에 연관된 사전 설정과 함께 한 번에 최대 4개의 맵이 표시됩니다. 페이지 매김된 보기가 화면 하단에 제공되므로 사용자가 페이지 사이를 탐색하고 추가 맵 및 사전 설정에 액세스할 수 있습니다. 맵이나 사전 설정을 선택하는 경우, 다른 페이지에서 나머지 맵과 사전 설정을 탐색하는 동안 선택 사항이 유지됩니다.
...
- **사전 설정 유형**: 맵 파일을 필터링할 사전 설정을 선택합니다. 예를 들어 *AEM 사이트* 사전 설정을 선택하면 *AEM 사이트* 출력 사전 설정이 구성된 맵만 표시됩니다.
...
>[!NOTE]
>
> 생성 기록에서 게시하면 항상 선택한 생성 대신 사전 설정의 최신 출력이 게시됩니다.
