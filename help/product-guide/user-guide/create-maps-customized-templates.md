...
**템플릿** 기능은 편집기[&#128279;](./web-editor-left-panel.md) 인터페이스의 왼쪽 패널에 있으며 관리자만 사용할 수 있습니다. 관리자는 이 패널을 사용하여 작성자가 사용할 수 있는 템플릿을 쉽게 만들고 관리할 수 있습니다. 기본적으로 템플릿은 *맵* 및 *주제* 형식 템플릿에서 분류됩니다.
