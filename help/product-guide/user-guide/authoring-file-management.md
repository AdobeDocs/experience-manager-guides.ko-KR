...
- *같은 위치에서 드래그 앤 드롭*: **기존 파일 덮어쓰기\**, **두 파일을 모두 유지\**&#x200B;할 수 있는 옵션이 제공됩니다.
...
*같은 위치에 파일을 드래그 앤 드롭하세요*: **기존 파일을 덮어씁니다\**.
...
*다른 위치에서 파일을 드래그 앤 드롭하십시오*: **기존 파일을 덮어씁니다\**, **파일을 새 위치로 이동합니다\**.
...
1. 설정에 따라 벌크 이동 도구 페이지가 표시됩니다. **일괄 이동 도구** 페이지에 다음 세부 정보를 제공합니다.
   ...
   >[!TIP]
   >
   > 선택 자세한 내용을 보려면 필드 근처 <img src="images/info-icon.svg" width="25">에서 확인하십시오.
   ...
   - **Source 경로\**: 이동할 폴더의 위치를 지정합니다.
     ...
     - **제거**&#x200B;를 선택하여 폴더를 제거할 수도 있습니다. 폴더 근처에 <img src="images/remove-folder.svg" width="25">이(가) 있습니다.


   - **대상 경로**: 원본 폴더를 이동할 위치를 지정하십시오.

     - **폴더 찾아보기** 선택 <img src="images/browse-folder-icon.svg" width="25">: 파일 찾아보기 대화 상자를 엽니다. 소스 폴더를 이동할 위치를 선택합니다. 선택을 선택하여 프로세스를 완료합니다.
