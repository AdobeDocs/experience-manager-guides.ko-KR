...
5. **작업 업데이트** 대화 상자에서 다음 작업 중 하나를 선택합니다.
   ...
   업데이트 작업 대화 상자에 있는 **검토 상태 확인** 옵션을 사용하여 [검토 작업의 상태를 확인](./review-manage-tasks-review-dashboard.md#check-the-status-of-a-review-task)할 수도 있습니다. 이 옵션을 선택하면 검토 작업의 상태 보고서가 표시되는 검토 대시보드로 이동합니다.
