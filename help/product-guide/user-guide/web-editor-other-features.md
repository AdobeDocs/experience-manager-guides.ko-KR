...
- Experience Manager Guides은 [MathType Web](https://docs.wiris.com/en/mathtype/mathtype_web/intro) 응용 프로그램과 통합하여 MathML 방정식 삽입을 위한 기본 지원을 제공합니다. MathML 방정식을 삽입하려면 **요소 삽입** 아이콘을 선택하고 mathml을 입력합니다. 목록에서 mathml 요소를 선택하면 **MathML 삽입** 대화 상자가 표시됩니다.
...
- **MathML 편집기에서 방정식 유효성 검사**
  ...
  Experience Manager Guides은 MathML 방정식이 포함된 주제를 저장할 때 해당 방정식의 유효성을 검사합니다.
...
- XML에서 공백에는 공백, 탭, 캐리지 리턴 및 빈 줄이 포함됩니다. Experience Manager Guides은 여러 개의 연속된 공백을 하나의 공백으로 변환합니다. 이렇게 하면 웹 편집기의 WYSIWYG 보기를 유지할 수 있습니다.
