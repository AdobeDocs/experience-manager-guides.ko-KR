...
- **컬렉션**: 선택한 파일을 컬렉션에 추가하려면 **컬렉션에 추가**&#x200B;를 선택합니다. 자세한 내용은 [왼쪽 패널](web-editor-features.md#left-panel) 섹션에서 **컬렉션** 기능 설명을 참조하십시오.

- **재사용 가능한 콘텐츠**: 선택한 파일을 재사용 가능한 콘텐츠 목록에 복사하려면 **재사용 가능한 콘텐츠에 추가**&#x200B;를 선택합니다. 자세한 내용은 [왼쪽 패널](web-editor-features.md#left-panel) 섹션에서 **재사용 가능한 콘텐츠** 기능 설명을 참조하십시오.
