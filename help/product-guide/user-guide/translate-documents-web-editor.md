...
1. 다음을 클릭합니다. **관리** 탭. 다음 **번역 패널** 사용 가능한 언어 그룹을 표시합니다.
...
1. 번역 타겟으로 원하는 언어 그룹을 선택할 수 있습니다. 다음을 수행하는 경우 **모두 선택**&#x200B;로 설정하면 선택한 파일이 기존 언어 그룹 내에서 사용 가능한 모든 언어로 번역됩니다.
...
1. 다음에서 **기타 언어**, 대상 폴더를 만들었지만 언어 그룹에 속하지 않은 모든 언어를 선택할 수 있습니다.
