...
1. 다음을 클릭합니다. **관리** 탭. [번역] 패널에는 **사용 가능한 언어** 목록을 표시합니다.
1. 다음에서 **사용 가능한 언어** 프로젝트를 번역할 로케일을 선택하십시오. 다음을 선택할 수 있습니다. **모두 선택** 을 클릭하여 프로젝트를 사용 가능한 모든 언어로 번역할 수 있습니다.
   ...
   >[!IMPORTANT]
   >
   > 이 목록에는 언어 폴더가 소스 언어와 병렬로 만들어지는 언어만 표시됩니다. 소스 언어 폴더의 한 수준 아래 등 다른 수준에서 만든 언어 폴더도 표시되지 않습니다. 모든 대상 언어 폴더를 소스 언어 폴더와 동일한 수준으로 만들어야 합니다.
