...
>[!NOTE]
>
> 이 작성 기능은 DITA 주제에만 사용할 수 있으며 편집기 인터페이스에서만 액세스할 수 있습니다. 홈 페이지 및 맵 콘솔에는 **도움말** 패널만 표시됩니다.
...
1. **작성** 패널에서 **텍스트 프롬프트 사용** ![ai 텍스트 프롬프트 사용 아이콘](./images/ai-use-text-prompt.svg)을 선택합니다.
...
1. 번역할 콘텐츠를 선택합니다.
1. **작성** 패널에서 **콘텐츠 번역** ![ai 콘텐츠 번역 아이콘](./images/ai-translate-content-icon.svg)을 선택합니다.
