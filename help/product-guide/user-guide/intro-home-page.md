...
- **추가 작업**: 추가 옵션에 대한 액세스를 제공합니다. 이 버튼을 선택하면 다음 옵션이 있는 메뉴가 열립니다.
   ...
   - **Workspace 설정**: **Workspace 설정** 대화 상자로 이동합니다. 자세한 내용은 [Workspace 설정 구성](../cs-install-guide/workspace-settings.md)을 참조하세요.
     ...
     >[!NOTE]
     >
     > 홈페이지에서 Workspace 설정 옵션은 버전 5.2 이상의 Cloud Services 및 On-Premise 구성에 사용할 수 있습니다. 버전 5.2 이전의 온-프레미스 설정에서는 홈 페이지에서 추가 작업 옵션을 사용할 수 없습니다. 그러나 기타 옵션 > 설정으로 이동하여 편집기 인터페이스와 맵 콘솔을 통해 관련 설정에 액세스할 수 있습니다.
...
>[!NOTE]
>
> 저장소는 왼쪽 패널에서 2025.11.0 릴리스의 Cloud Service 설정 및 5.2 릴리스의 On-Premise 설정에 사용할 수 있습니다. 5.2 이전 버전의 On-Premise 설정의 경우 편집기 인터페이스에서 저장소에 계속 액세스할 수 있습니다.
