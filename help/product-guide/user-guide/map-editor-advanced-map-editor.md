...
1. 주제 편집이 끝나면 다음 작업을 수행할 수 있습니다.
   ...
   - 다음을 사용하여 항목을 체크 인할 수 있습니다. **새 버전으로 저장 및 잠금 해제** 단추를 클릭합니다. 주제의 버전을 저장하면 새 버전이 만들어지고 잠금도 해제됩니다.

     파일을 체크 인하기 전에 변경 내용을 저장하는 것이 좋습니다.  변경 사항을 저장하면 XML 파일의 유효성이 검사됩니다.

   - 다음을 사용하여 여러 항목을 선택하고 체크 인할 수도 있습니다. **새 버전으로 저장 및 잠금 해제** 단추를 클릭합니다. 항목 버전을 저장하면 각 항목에 대해 새 버전이 만들어지고 잠금이 해제됩니다. 또한 의 주제에서 체크인 진행 상황을 확인할 수 있습니다. **새 버전으로 저장 및 잠금 해제** 대화 상자. 파일을 체크 인하면 성공 메시지가 표시됩니다.
