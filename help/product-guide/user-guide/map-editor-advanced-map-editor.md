...
- **기타 특성** 관리자가 특성에 대한 프로필을 만든 경우 해당 특성이 구성된 값과 함께 제공됩니다. 콘텐츠 속성 패널을 사용하여 이러한 속성을 선택하고 주제의 관련 콘텐츠에 할당할 수 있습니다. 편집기 설정의 **특성 표시** 탭에서 관리자가 구성한 특성을 할당할 수도 있습니다. 요소에 대해 정의된 속성이 레이아웃 및 아웃라인 뷰에 표시됩니다. 이렇게 하면 특정 속성이 정의된 맵의 모든 항목을 빠르게 볼 수 있습니다. 예를 들어 `audience` 특성이 있는 모든 항목은 `US`(으)로 정의됩니다.
