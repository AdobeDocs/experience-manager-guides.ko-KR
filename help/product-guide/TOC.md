   ...
   - 릴리스 정보 {#release-notes}
      - 클라우드 서비스 {#cloud-release-notes}
         ...
         - 2024 릴리스 {#2024-releases}
            ...
            - 2024.10.0 SP1 릴리즈 {#2410-0-sp1-release}
...
- 사용 안내서 (새 UI) {#user-guide}
   ...
   - 콘텐츠 작성 {#author-content}
      ...
      - 편집기 {#work-with-editor}
         ...
         - [편집기에서 Markdown 문서 작성자](./user-guide/web-editor-markdown-topic.md)
         - [컨텐츠 추가](./user-guide/web-editor-apply-citations.md)
      ...
      - 맵 편집기 {#map-editor}
         - [지도 편집기 소개](./user-guide/map-editor.md)
   ...
   - 콘텐츠 검토 {#review}
      ...
      - [알림 기능을 사용하여 검토 작업 재배정](./user-guide/reassign-review-using-notification.md)
      - [주제 검토](./user-guide/review-topics.md)
      - [주소 검토 댓글](./user-guide/review-address-review-comments.md)
      ...
      - 출력 생성 {#output-gen}
         ...
         - 출력 생성 {#generate-output}
            ...
            - 단일 주제 게시 {#single-topic-publishing}
               ...
               - [경험 조각 Publish](./user-guide/publish-experience-fragment.md)
               - [Publish AEM Sites 페이지](./user-guide/publish-aem-sites.md)
               - [증분 출력 생성](./user-guide/generate-output-aem-site.md)
         - [출력 생성에 Map Collection 사용](./user-guide/generate-output-use-map-collection-output-generation.md)
...
- 설치 및 구성 {#install-guide}
   - 온프레미스 {#on-prem-ig}
      ...
      - [폴더에 대한 게시물 처리 구성](./install-guide/conf-folder-post-processing.md)
      ...
      - 웹 편집기 구성 작업 {#web-editor-configs}
         ...
         - [태그 보기 기본값 구성](./install-guide/configure-default-value-tags-view.md)
      ...
      - 출력 생성 설정을 사용한 작업 {#output-gen-config}
         ...
         - [기본 PDF 퍼블리싱 JVM 플래그 구성](./native-pdf/configure-jvm-flags.md)
         - 사용자 지정 워크플로우 작업 {#custom-workflow}
         - [워크플로우 구성 및 사용자 지정](./install-guide/customize-workflows.md)
   ...
   - 기사 {#kb-articles}
      ...
      - 게시 {#publishing}
         - 기본 PDF {#native-pdf}
            ...
            - [기본 PDF 퍼블리싱을 위한 AEM 환경 구성](./knowledge-base/kb-articles/publishing/configuring-aem-environment-for-native-pdf-publishing.md)
            - [PDF의 첫 번째 페이지에 엔터프라이즈 브랜딩 추가](./knowledge-base/kb-articles/publishing/add-branding-to-bookmap-content-header.md)
            - [기본 PDF 퍼블리싱에서 북맵의 목차 생성](./knowledge-base/kb-articles/publishing/how-to-include-bookmap-toc-in-pdf-publishing.md)
         - 디타-OT {#dita-ot}
