...
- 사용 안내서 (새 UI) {#user-guide}
   ...
   - 학습 콘텐츠 관리 {#learning-training-content}
      - 시작 안내서 {#get-started}
         - 소개 {#intro-lc}
            - [릴리스 정보](./release-info-lt/release-notes-lt-2025-12-v2.md)
            - [릴리스 정보](./release-info-lt/release-notes-lt-2026-02-v3.md)
...
- 설치 및 구성 {#install-guide}
   - 온프레미스 {#on-prem-ig}
      ...
      - 출력 생성 설정을 사용한 작업 {#output-gen-config}
         ...
         - [AEM Sites에 대한 구성 요소 매핑](./install-guide/component-mapping.md)
   ...
   - 클라우드 서비스 {#cs-ig}
      ...
      - 문서 상태 작업 {#doc-state-cs}
         ...
         - [문서 상태 필터 구성](./cs-install-guide/config-doc-state-filters.md)
      ...
      - 출력 생성 설정을 사용한 작업 {#output-gen-config-cs}
         ...
         - [AEM Sites에 대한 구성 요소 매핑](./cs-install-guide/component-mapping.md)
