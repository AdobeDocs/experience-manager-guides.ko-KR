...
|---|---|---|---|---|---|---|
| Adobe Experience Manager Guides 2026.05.0 <br> | 자동 업데이트 | 2026년 5월 11~13일 | - | - | - | 대상 |
...
| 릴리스 | 이벤트 | 일정 | 새로운 기능 | 업그레이드 지침 | 해결된 문제 | 상태 |
|---|---|---|---|---|---|---|
| Adobe Experience Manager Guides 2026.03.0 <br> [(AEM 릴리스 - 24893)](https://experienceleague.adobe.com/ko/docs/experience-manager-cloud-service/content/release-notes/maintenance/latest) | 자동 업데이트 | 2026년 3월 23~25일 | [여기](whats-new-2026-03-0.md) | [여기](upgrade-instructions-2026-03-0.md) | [여기](fixed-issues-2026-03-0.md) | 업데이트됨 |
...
|---|---|---|---|---|---|
| Adobe Experience Manager Guides 5.2.0 | 릴리스 | 2026년 4월 둘째 주 | - | - | 대상 |
...
| 릴리스 | 이벤트 | 일정 | 새로운 기능 | 업그레이드 지침 | 상태 |
|---|---|---|---|---|---|
| Adobe Experience Manager Guides 5.1.0 | 서비스 팩 4 | 2026년 4월 1일 목요일 | - | [여기](upgrade-instructions-5-1-0-sp4.md) | 릴리스됨 |
| Adobe Experience Manager Guides 5.0.0 | 서비스 팩 4 | 2026년 4월 1일 목요일 | - | [여기](upgrade-instructions-5-0-0-sp4.md) | 릴리스됨 |
| Adobe Experience Manager Guides 5.0.0 | 서비스 팩 3 | 2026년 2월 2일 화요일 | - | [여기](upgrade-instructions-5-0-0-sp3.md) | 릴리스됨 |
