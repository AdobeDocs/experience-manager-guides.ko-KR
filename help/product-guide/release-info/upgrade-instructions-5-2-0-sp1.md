...
이 문서에서는 Adobe Experience Manager Guides 5.2.0 서비스 팩 1 릴리스의 업그레이드 지침 및 호환성 매트릭스를 다룹니다.

새로운 기능 및 향상된 기능에 대한 자세한 내용은 [5.2.0 서비스 팩 1 릴리스의 새로운 기능](../release-info/whats-new-5-2-1.md)을 참조하세요.

이 릴리스에서 해결된 문제 목록을 보려면 [5.2.0 서비스 팩 1 릴리스에서 해결된 문제](../release-info/fixed-issues-5-2-0-sp1.md)를 확인하십시오.

## 호환성 매트릭스

이 섹션에서는 Experience Manager Guides 5.2.0 서비스 팩 1 릴리스에서 지원하는 소프트웨어 응용 프로그램에 대한 호환성 매트릭스를 나열합니다.

| AEM Guides | AEM 버전 | 서비스 팩 |
| --- | --- | --- |
| 5.2.0 서비스 팩 1(UUID) | 6.5 LTS | 2 |
| 5.2.0 서비스 팩 1(UUID) | 6.5 | 24, 23, 22 |

자세한 내용은 On-Premise 설치 및 구성 안내서의 [기술 요구 사항](../install-conf-guide/aemg-technical-requirements.md) 섹션을 참조하십시오.
...
| 릴리스 | FMPS | FM |
| --- | --- | --- |
| 5.2.0 서비스 팩 1(UUID) | 지원됨 | 2026 이상 |

### 산소 연결기

| 릴리스 | 산소 커넥터 창 | 산소 커넥터 Mac | Oxygen 창에서 편집 | Oxygen Mac에서 편집 |
| --- | --- | --- |--- |--- |
| 5.2.0 서비스 팩 1(UUID) | 3.8-uuid.1 | 3.8-uuid.1 | 2.3 | 2.3 |
...
|---|---|---| ---|
| 5.2.0 서비스 팩 1 UUID | 6.5 LTS | guides-components.all-1.4.1 | NA |
| 5.2.0 서비스 팩 1 UUID | 6.5 | guides-components.all-1.4.0 | aemg-sites-template-1.3.0 |

## 사전 요구 사항

Experience Manager Guides 5.2.0 서비스 팩 1 업그레이드 프로세스를 시작하기 전에 다음을 확인하십시오.

1. Experience Manager Guides 버전 5.2.0으로 업그레이드되었습니다.
...
## Experience Manager Guides 5.2.0 서비스 팩 1의 업그레이드 경로

현재 버전의 Experience Manager Guides을 **AEM 6.5** 또는 **AEM 6.5 LTS**&#x200B;의 버전 5.2.0 서비스 팩 1로 쉽게 업그레이드할 수 있습니다.
...
- 버전 5.2.0을 사용 중인 경우 버전 5.2.0 서비스 팩 1로 바로 업그레이드할 수 있습니다.
...
## Experience Manager Guides 5.2.0 서비스 팩 1의 업그레이드 프로세스

>[!IMPORTANT]
>
> 사후 처리 및 인덱싱에는 몇 시간이 걸릴 수 있습니다. 사용량이 적은 시간 동안 업그레이드 프로세스를 시작하는 것이 좋습니다.

1. [Adobe 소프트웨어 배포 포털](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html)에서 5.2.0 서비스 팩 1 버전 패키지를 다운로드합니다.
