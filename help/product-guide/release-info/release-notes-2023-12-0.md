---
title: 릴리스 정보 | 업그레이드 지침 및 2023년 12월 Adobe Experience Manager Guides 릴리스의 해결된 문제
...
2. 클라우드 서비스 Git 코드의 `/dox/dox.installer/pom.xml` 파일에서 `<dox.version>` 속성을 2023.12.0.16으로 업데이트합니다.
...
- 웹 편집기 탭의 **Title**&#x200B;이(가) 점(.) 다음에 잘립니다. 문자. (14372)
