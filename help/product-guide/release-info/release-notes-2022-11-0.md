...
1. 클라우드 서비스 Git 코드의 `/dox/dox.installer/pom.xml` 파일에서 `<dox.version>` 속성을 2022.11.198로 업데이트합니다.
...
### 기본 PDF | 변경 막대가 있는 PDF(문서 버전 간의 차이점 표시)
...
* 기본 PDF | `conkeyref`이(가) 생성된 PDF 출력에서 확인되지 않습니다. (10564)
