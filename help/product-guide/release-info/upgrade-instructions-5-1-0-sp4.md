...
이 릴리스에서 해결된 문제 목록을 보려면 [5.1.0 서비스 팩 4 릴리스에서 해결된 문제](../release-info/fixed-issues-5-1-0-sp4.md)를 확인하십시오.

## 호환성 매트릭스

이 섹션에서는 Experience Manager Guides 5.1.0 서비스 팩 4 릴리스에서 지원하는 소프트웨어 응용 프로그램에 대한 호환성 매트릭스를 나열합니다.
...
| 릴리스 | FMPS | FM |
| --- | --- | --- |
| 5.1.0 서비스 팩 4(UUID) | 지원됨 | 2022년 이상 |

### 산소 연결기

| 릴리스 | 산소 커넥터 창 | 산소 커넥터 Mac | Oxygen 창에서 편집 | Oxygen Mac에서 편집 |
| --- | --- | --- |--- |--- |
| 5.1.0 서비스 팩 4(UUID) | 3.8-uuid.1 | 3.8-uuid.1 | 2.3 | 2.3 |
...
|---|---|---| ---|
| 5.1.0 서비스 팩 4 UUID | 6.5 LTS | guides-components.all-1.4.1 | aemg-docs.all-1.2.0 |
| 5.1.0 서비스 팩 4 UUID | 6.5 | guides-components.all-1.4.0 | aemg-docs.all-1.2.0 |
...
## Experience Manager Guides 5.1.0 서비스 팩 4 릴리스로 업그레이드

현재 버전의 Experience Manager Guides을 **AEM 6.5** 또는 **AEM 6.5 LTS**&#x200B;의 버전 5.1.0 서비스 팩 4로 쉽게 업그레이드할 수 있습니다.
...
- 버전 5.1.0 또는 5.1.x를 사용 중인 경우 버전 5.1.0 서비스 팩 4로 바로 업그레이드할 수 있습니다.
