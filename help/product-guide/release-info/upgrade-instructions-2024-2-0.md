...
이 섹션에서는 Experience Manager 가이드의 2024.2.0 릴리스에서 지원되는 소프트웨어 애플리케이션에 대한 호환성 매트릭스를 as a Cloud Service으로 나열합니다.
...
기존 릴리스에 대해 이전에 수행한 적이 없는 경우 Experience Manager 가이드 as a Cloud Service에 대해 다음 단계를 수행하십시오.
