---
title: 릴리스 정보 | Adobe Experience Manager Guides 4.6.0 릴리스에 대한 업그레이드 지침
description: Adobe Experience Manager Guides 4.6.0 릴리스로 업그레이드하는 방법 알아보기
role: Leader
...
# 4.6.0 릴리스에 대한 업그레이드 지침(2024년 9월)

이 문서에서는 Adobe Experience Manager Guides 4.6.0 릴리스의 업그레이드 지침 및 호환성 매트릭스를 다룹니다.

새로운 기능 및 개선 사항에 대한 자세한 내용은 [4.6.0 릴리스의 새로운 기능](../release-info/whats-new-4-6.md)을 참조하십시오.
...
| --- | --- | --- | --- | --- |
| 4.6.0(비 UUID) | 2022년 이상 | 2020.2 이상* | 2022년 이상 | 2020.3 이상 |
| 4.6.0(UUID) | 2022년 이상 | 2020.2 이상* | 2022년 이상 | 2020.4 이상 |
| | | | | |
...
| --- | --- | --- |--- |--- |
| 4.6.0(비 UUID) | 2.8-regular-10 | 2.8-regular-10 | 1.6 | 1.6 |
...
## Experience Manager Guides 4.6.0 릴리스로 업그레이드

현재 버전의 Guides를 버전 4.6.0으로 쉽게 업그레이드할 수 있습니다. Experience Manager Guides 버전 4.6.0으로 업그레이드하기 전에 다음 사항을 고려해야 합니다.
