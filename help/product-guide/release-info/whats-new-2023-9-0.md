...
자세한 내용은 [콘텐츠 조각에 게시](../user-guide//publish-content-fragment.md)를 참조하십시오.
...
AEM Guides을 보다 강력한 제품으로 만들기 위해 2023년 9월 릴리스에서 다음과 같은 네이티브 PDF 개선 사항이 수행되었습니다.
...
![맵 컬렉션 편집](assets/edit-map-collection-cs.png){width="800"}\
