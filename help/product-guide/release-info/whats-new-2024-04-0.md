...
description: Adobe Experience Manager Guides as a Cloud Service 2024.4.0 릴리스의 새로운 기능과 향상된 기능에 대해 알아봅니다.
...
![번역 패널](assets/translation-languages-2404.png){width="300"}
...
이제 게시 인스턴스에서 벌크 활성화 컬렉션에 대한 출력을 활성화할 뿐만 아니라 Experience Manager Gudies as Cloud Services가 **미리 보기** 인스턴스에서 활성화하는 기능을 제공합니다.


이 기능을 사용하면 콘텐츠를 미리 보기 인스턴스에 활성화할 수 있으므로 콘텐츠를 **게시** 인스턴스에 활성화하기 전에 모양 및 작동 방식을 확인할 수 있습니다.


![이(가) 일괄 활성화 컬렉션 감사 기록 탭을 만들었습니다](assets/bulk-collection-audit-history.png){width="800"}
...
![콘텐츠 스니펫 삽입 대화 상자](assets/insert-content-snippet.png){width="800"}
...
그런 다음 작성자는 데이터 소스에 연결하여 생성기를 사용하여 콘텐츠 스니펫이나 주제를 만듭니다. 이 기능을 사용하면 각 URL에 대한 데이터 소스를 만들 필요가 없기 때문에 유용합니다. 이는 단일 콘텐츠 스니펫 또는 주제의 특정 데이터 소스에 대한 모든 리소스에서 데이터를 빠르게 가져오는 데 도움이 됩니다.

데이터 소스 커넥터에 대한 자세한 내용과 [사용자 인터페이스에서 데이터 소스 커넥터를 구성하는 방법](../cs-install-guide/conf-data-source-connector-tools.md)을 확인하십시오.
...
사용자 환경 설정의 ![모양 탭](assets/user_preference_editor_appearance.png){width="550"}
...
![저장소 보기에서 파일 검색](assets/repository-filter-search-2404.png){width="300"}
...
![요소 삽입 대화 상자](assets/insert-element-dialog.png){width="300"}
...
![콘텐츠 속성에 드롭다운 메뉴 입력](assets/content-properties-type.png){width="300"}
...
![새 버전으로 저장 및 잠금 해제 대화 상자](./assets/save-version-lock.png){width="300"}
...
DITA-OT를 통해 AEM 사이트, HTML, 사용자 지정, JSON 또는 PDF 출력을 게시할 때 생성된 임시 파일을 다운로드할 수도 있습니다. 이 기능을 사용하면 출력 생성 프로세스 중에 발생할 수 있는 문제를 분석하고 효과적으로 해결할 수 있습니다.  
