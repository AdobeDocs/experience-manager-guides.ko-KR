---
title: 릴리스 노트 | Adobe Experience Manager Guides 5.0.0 서비스 팩 4 릴리스에 대한 업그레이드 지침
...
# 5.0.0 서비스 팩 4 릴리스(2026년 4월)의 업그레이드 지침

이 문서에서는 Adobe Experience Manager Guides 5.0.0 서비스 팩 4 릴리스의 업그레이드 지침 및 호환성 매트릭스를 다룹니다.

이 릴리스에서 해결된 문제 목록을 보려면 [5.0.0 서비스 팩 4 릴리스에서 해결된 문제](../release-info/fixed-issues-5-0-0-sp4.md)를 확인하십시오.

## 호환성 매트릭스

이 섹션에서는 Experience Manager Guides 5.0.0 서비스 팩 4 릴리스에서 지원하는 소프트웨어 응용 프로그램에 대한 호환성 매트릭스를 나열합니다.
...
| 릴리스 | FMPS | FM |
| --- | --- | --- |
| 5.0.0 서비스 팩 4(UUID) | 지원됨 | 2022년 이상 |

### 산소 연결기

| 릴리스 | 산소 커넥터 창 | 산소 커넥터 Mac | Oxygen 창에서 편집 | Oxygen Mac에서 편집 |
| --- | --- | --- |--- |--- |
| 5.0.0 서비스 팩 4(UUID) | 3.7-uuid.2 | 3.7-uuid.2 | 2.3 | 2.3 |
...
## Experience Manager Guides 5.0.0 서비스 팩 4 릴리스로 업그레이드

현재 버전의 Guides를 버전 5.0.0 서비스 팩 4로 쉽게 업그레이드할 수 있습니다. Experience Manager Guides 버전 5.0.0 서비스 팩 4로 업그레이드하기 전에 다음 사항을 고려해야 합니다.

- 버전 5.0.0 또는 5.0.x를 사용 중인 경우 버전 5.0.0 서비스 팩 4로 바로 업그레이드할 수 있습니다.
