...
description: 호환성 매트릭스와 Adobe Experience Manager Guides as a Cloud Service 2024.06.0 릴리스로 업그레이드하는 방법에 대해 알아보십시오.
...
이 문서에서는 Adobe Experience Manager Guides as a Cloud Service 2024.06.0 릴리스의 업그레이드 지침 및 호환성 매트릭스를 다룹니다.
...
이 섹션에서는 Experience Manager Guides as a Cloud Service 2024.06.0 릴리스에서 지원되는 소프트웨어 애플리케이션에 대한 호환성 매트릭스를 나열합니다.
...
|---|---|---|
| Cloud Service용 Experience Manager Guides 구성 요소 콘텐츠 패키지 | dxml-components.all-1.2.2 | aem-site-template-dxml.all-1.0.16 |
