...
이 문서에서는 Adobe Experience Manager Guides as a Cloud Service 2024.10.0 릴리스의 업그레이드 지침 및 호환성 매트릭스를 다룹니다.
...
이 섹션에서는 Experience Manager Guides as a Cloud Service 2024.10.0 릴리스에서 지원되는 소프트웨어 애플리케이션에 대한 호환성 매트릭스를 나열합니다.
