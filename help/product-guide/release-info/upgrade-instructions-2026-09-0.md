---
title: 릴리스 정보 | Adobe Experience Manager Guides, 2026.09.0 릴리스의 업그레이드 지침 및 해결된 문제
description: 호환성 매트릭스와 Adobe Experience Manager Guides as a Cloud Service 2026.09.0 릴리스로 업그레이드하는 방법에 대해 알아보십시오.
source-git-commit: c3c72732237f937fef0213afbbd7f20cc1d9ee65
workflow-type: tm+mt
source-wordcount: '417'
ht-degree: 1%
---
# 2026.09.0 릴리스에 대한 업그레이드 지침

이 문서에서는 Adobe Experience Manager Guides as a Cloud Service 2026.09.0 릴리스의 업그레이드 지침 및 호환성 매트릭스를 다룹니다.
...
이 섹션에서는 Experience Manager Guides as a Cloud Service 2026.09.0 릴리스에서 지원되는 소프트웨어 애플리케이션에 대한 호환성 매트릭스를 살펴봅니다.
...
| --- | --- | --- | --- |
| 2026.09.0 | 호환되지 않음 | 2022년 이상 | 26.1 |
