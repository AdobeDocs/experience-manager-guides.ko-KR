---
title: 릴리스 정보 | 업그레이드 지침 및 2023년 11월 Adobe Experience Manager Guides 릴리스의 해결된 문제
...
2. 클라우드 서비스 Git 코드의 `/dox/dox.installer/pom.xml` 파일에서 `<dox.version>` 속성을 2023.11.0.406으로 업데이트합니다.
