...
- 자동 들여쓰기 기능을 사용한 후 Experience Manager DITA 안내서에서 저장 기능을 트리거하지 못합니다. (16482)
...
- 큰 스타일시트나 레이아웃 템플릿을 사용할 때 기본 PDF 생성이 실패합니다. (15344)
...
- 아직 번역 프로세스에 있는 맵에 대해 벌크 게시 대시보드가 비어 있습니다. (19352)
...
- 웹 편집기에서 기준 요소 만들기의 기본 시간은 현재 시간이 아닌 00:00(으)로 표시됩니다. (15215)
...
- 관리자가 아닌 사용자에 대한 오류로 XLIFF 기반 번역이 실패합니다(17296).
...
- 사전 설정에서 적용된 조건 필터링은 **PDF으로 다운로드**&#x200B;를 통해 적용되지 않습니다.
...
- 자산 UI에서 DITA 파일을 선택하면 구성 설정에서 **FrameMaker에서 열기** 옵션이 비활성화되어 있지만 표시됩니다.
