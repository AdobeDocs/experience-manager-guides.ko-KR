...
description: Adobe Experience Manager Guides as a Cloud Service 2024.10.0 릴리스의 버그 수정에 대해 알아봅니다.
...
이 문서에서는 Adobe Experience Manager Guides as a Cloud Service의 2024.10.0 릴리스의 다양한 영역에서 수정된 버그를 다룹니다.
...
- 작성자 보기에서 이미지 복사/붙여넣기가 Adobe Experience Manager Guides as a Cloud Service의 2024.06.0 릴리스에서 작동하지 않습니다(18062).
...
- Experience Manager Guides as a Cloud Service의 PDF 렌더링 기능에서 간헐적인 오류가 발생합니다. (16966)
...
- 레이아웃에 메타데이터 필드가 포함된 경우 고객 템플릿의 스타일 및 콘텐츠 서식이 자동으로 변경되어 게시된 PDF에서 잘못된 서식이 발생합니다. (17900)
- 라이트닝 URL로 Salesforce 연결 유효성 검사가 실패합니다. (17797)
- 게시된 콘텐츠의 일괄 활성화 중에 **일괄 게시 대시보드**&#x200B;에서 참조된 PDF이 활성화되지 않았습니다. (17793)
...
- Node.js에 대한 종속성 가져오기와 관련된 오류로 인해 기본 PDF 생성에 실패합니다. (14445)
...
- DITA 맵에 최대 7 이상의 제목 수준이 포함된 경우 수준 7 제목은 기본 PDF 출력에서 수준 1 제목으로 잘못 처리됩니다. (19698)
...
- **일괄 게시 대시보드**&#x200B;에 아직 번역 프로세스에 있는 맵에 대한 빈 항목이 표시됩니다. (19352)
...
- InDesign에서 DITA로의 변환에는 하드 코딩된 구성 경로가 있으므로 사용자 지정 구성 파일을 선택하지 않습니다. (16891)
