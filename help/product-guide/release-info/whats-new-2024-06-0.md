...
description: Adobe Experience Manager Guides as a Cloud Service 2024.06.0 릴리스의 새로운 기능 및 향상된 기능에 대해 알아봅니다.
...
![파일 속성 옵션 탭](./assets/file-properties-outputs-tab.png){width="300"}
...
![메타데이터 네이티브 pdf 추가](./assets/add-metadata-native-pdf.png) {width="300"}
...
![요소 서라운드 대화 상자](./assets/surround-element.png) {width="300"}
...
Experience Manager Guides은 기본 PDF 게시에서 Markdown 문서도 지원합니다. 이 기능은 편리하며 DITA 맵에서 Markdown 파일에 대한 PDF를 생성하는 데 도움이 됩니다. 기본 PDF 게시의 Markdown 지원을 통해 문서를 쉽게 만들고, 관리하고, 공유할 수 있습니다.
