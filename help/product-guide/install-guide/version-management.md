...
다중 사용 환경에서는 사용자가 시스템에서 파일을 삭제하지 않도록 하는 것도 중요합니다. 이 요구 사항은 다른 사용자가 체크 아웃한 파일에 더 중요합니다.다른 사용자가 체크 아웃한 파일을 사용자가 덮어쓰는 것을 허용하거나 금지할 수 있습니다. 사용자가 시스템에서 체크 아웃된 파일을 실수로 삭제하지 못하도록 AEM Guides에서 사용할 수 있는 구성을 제공합니다. 체크 아웃된 파일 외에도 참조가 들어 있거나 다른 파일에서 참조된 파일의 삭제를 제어할 수도 있습니다. 또한 업로드된 파일에 대한 새 버전을 만들 수도 있습니다.
