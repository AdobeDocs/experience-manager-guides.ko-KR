...
- [워크플로 관리](https://helpx.adobe.com/experience-manager/6-5/sites/administering/using/workflows.html)
...
| `payloadJson` | JSON 오브젝트 | 다음 값을 지정하십시오.<br> - `base`: 검토를 위해 보낸 항목이 포함된 상위 폴더의 경로.<br> - `asset`: 검토를 위해 보낸 항목의 경로. <br>- `referrer`: 비워 둡니다. |
