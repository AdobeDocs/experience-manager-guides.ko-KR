...
현재 버전의 Experience Manager Guides을 버전 4.4.0으로 업그레이드할 수 있습니다.
...
1. **DAM 자산 업데이트 워크플로우 \(Post 처리 변경 사항\):**
...
1. **편집**&#x200B;을 클릭합니다.
1. **DXML Post 프로세스 개시자** 구성 요소가 있는 경우 사용자 지정 내용이 동기화되었는지 확인하십시오.
1. **DXML Post 프로세스 개시자** 구성 요소가 없으면 다음 단계를 수행하여 해당 구성 요소를 삽입합니다.
