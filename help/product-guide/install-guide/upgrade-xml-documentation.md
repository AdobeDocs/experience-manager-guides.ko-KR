...
>[!TIP]
>
> 버전 5.0.0 서비스 팩 3으로 업그레이드하는 방법은 현재 버전의 Experience Manager Guides에 따라 다릅니다. 버전 5.0.0 서비스 팩 2, 5.0.0 서비스 팩 1 또는 5.0.0을 사용 중인 경우 버전 5.0.0 서비스 팩 3으로 직접 업그레이드할 수 있습니다.
...
>[!NOTE]
>
>5.1.0 서비스 팩 3으로 업그레이드하는 경우 Experience Manager Guides 버전 5.1.0 또는 5.1.x에 있어야 합니다.
