...
현재 버전의 Experience Manager Guides을 버전 5.0.0 서비스 팩 1로 업그레이드할 수 있습니다.


- 버전 5.0.0, 4.6.x, 4.6 또는 4.4를 사용하는 경우 버전 5.0.0 서비스 팩 1로 바로 업그레이드할 수 있습니다.
...
>[!TIP]
>
> 버전 5.0.0 서비스 팩 1로 업그레이드하는 방법은 현재 버전의 Experience Manager Guides에 따라 다릅니다. 버전 5.0.0, 4.6.4, 4.6.3, 4.6.1, 4.6.0 또는 4.4를 사용하는 경우 버전 5.0.0 서비스 팩 1로 바로 업그레이드할 수 있습니다.
