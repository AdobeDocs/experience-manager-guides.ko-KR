...
현재 버전의 Experience Manager Guides을 버전 4.6.0 서비스 팩 3으로 업그레이드할 수 있습니다.
...
>[!TIP]
>
> 버전 4.6.0 또는 4.6.0 서비스 팩 1 위에 4.6.0 서비스 팩 3을 설치하는 것이 좋습니다. 4.6.0 서비스 팩 3 릴리스의 업그레이드 프로세스는 4.6.0 릴리스와 동일한 단계를 따릅니다.
