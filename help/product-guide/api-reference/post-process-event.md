---
title: Post 처리 이벤트 핸들러
description: Post 처리 이벤트 핸들러에 대해 알아보기
...
|`message`|문자열|상태가 COMPLETED WITH ERRORS 또는 FAILED인 경우 이 매개 변수에는 오류 또는 실패 이유에 대한 세부 정보가 포함됩니다.|
