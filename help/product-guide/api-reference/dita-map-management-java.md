...
---- ---------------
|`session`|javax.jcr.Session|올바른 JCR 세션입니다.|
기준 요소 정보를 검색할 DITA 맵 파일의 |`sourcePath`|String|Path\(AEM 저장소에 있음).|
...
---- ---------------
|`session`|javax.jcr.Session|올바른 JCR 세션입니다.|
조건부 사전 설정 정보를 검색할 DITA 맵 파일의 |`sourcePath`|String|Path\(AEM 저장소 내).|
...
---- ---------------
|`session`|javax.jcr.Session|올바른 JCR 세션입니다.|
DITAVAL 파일을 검색할 DITA 맵 파일의 |`sourcePath`|String|Path\(AEM 저장소 내).|
