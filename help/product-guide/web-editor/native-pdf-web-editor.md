...
* **메타데이터 이름 및 값 제공**
   ...
   1. 메타데이터 값을 입력하고 &#39;+&#39; 아이콘을 선택합니다.메타데이터가 PDF의 메타데이터 목록에 추가됩니다.

변수를 사용하여 메타데이터 값을 정의할 수도 있습니다.  DITA 맵 또는 북맵 파일에 대해 정의된 메타데이터를 변수로 사용할 수 있습니다. 메타데이터는 DITA 맵 또는 북맵 파일의 `/jcr:content/metadata` 노드에서 찾을 수 있습니다.변수를 사용하는 경우 메타데이터 속성에서 해당 값이 선택됩니다.
