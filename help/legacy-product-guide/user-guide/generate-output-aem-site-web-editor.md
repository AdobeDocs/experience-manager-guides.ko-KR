...
| 기준선 사용 | 선택한 DITA 맵에 대한 기준선을 만든 경우 게시할 버전을 지정하려면 이 옵션을 선택하십시오.<br><br>**중요**: AEM 사이트에 대한 증분 출력을 생성할 때 첨부 기준선이 아닌 파일의 현재 버전을 사용하여 출력이 만들어집니다.<br><br>자세한 내용은 [기준선으로 작업](generate-output-use-baseline-for-publishing.md#id1825FI0J0PF)을 참조하십시오. |
