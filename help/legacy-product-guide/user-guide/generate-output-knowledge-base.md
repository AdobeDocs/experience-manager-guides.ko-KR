...
| ServiceNow 옵션 | 설명 |
| --- | --- |
| 프로필 게시 | 드롭다운을 사용하여 관리자가 구성하는 ServiceNow 연결 프로필에서 선택합니다. 관리자가 게시 프로필을 만드는 방법에 대한 자세한 내용은 **왼쪽 패널** 섹션에서 [편집기 설정](./web-editor-features.md#id2051EA0M0HS) 기능 설명을 참조하십시오. |
...
| Salesforce 옵션 | 설명 |
| --- | --- |
| 프로필 게시 | 드롭다운을 사용하여 관리자가 구성하는 Salesforce 연결 프로필에서 선택합니다. 관리자가 게시 프로필을 만드는 방법에 대한 자세한 내용은 **왼쪽 패널** 섹션에서 [편집기 설정](./web-editor-features.md#id2051EA0M0HS) 기능 설명을 참조하십시오. |
